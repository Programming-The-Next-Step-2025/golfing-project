...
vignette: >
  %\VignetteIndexEntry{golf_weather_report}
...
Retrieves live weather data from OpenWeatherMap based on coordinates. You can 
see the following weather variables:
...
You can access the app by running this function:
